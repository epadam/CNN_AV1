...
NUM_DENLAYER1_FEATURES_16 = 64       
NUM_DENLAYER2_FEATURES_16 = 48
...
def net(x, qp, isdrop):
    ...
    h_image_L = zero_mean_norm_local(x_image, 16, 16)
    ...
    h_fc1_16_c = tf.concat([h_fc1_16, qp], axis=1)
    h_fc2_16 = full_connect(h_fc1_16_c, NUM_DENLAYER1_FEATURES_16 + NUM_EXT_FEATURES, NUM_DENLAYER2_FEATURES_16, 
                            acti_mode=acti_mode_fc, keep_prob=1-isdrop*0.2, name_w='h_fc2__16__w', name_b='h_fc2__16__b')    
    h_fc2_16_c = tf.concat([h_fc2_16, qp], axis=1)
    y_conv_flat_16 = full_connect(h_fc2_16_c, NUM_DENLAYER2_FEATURES_16 + NUM_EXT_FEATURES, 10, 
                            acti_mode = 0 , name_w='y_conv_flat__16__w', name_b='y_conv_flat__16__b')

    opt_vars_all_16 = [v for v in tf.trainable_variables()]
    ...
    return y_conv_flat_16, opt_vars_all_16
...
#but for evaluation, softmax is not really necessary, as long as the biggst number is obvious
